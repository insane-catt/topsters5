...
> **Released** — Once a development preview, Topsters5 is now officially public.
>
> **正式公開** — 開発中プレビューを経て、正式に公開しました。

A fork of [GiraffeKey's ChartYourMusic](https://github.com/GiraffeKey/chartyourmusic), with added mobile support and other improvements. Some features also draw on the implementation of [Topsters 3](https://github.com/camdendotlol/topstersorg).

[GiraffeKeyさん の ChartYourMusic](https://github.com/GiraffeKey/chartyourmusic) をベースに、モバイル対応などの改善を加えたフォークです。一部の機能は [Topsters 3](https://github.com/camdendotlol/topstersorg) の実装を参考にしています。

Available here / こちらで公開中: <https://topsters5.vercel.app/>
